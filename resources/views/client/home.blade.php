                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 mb-30">
                            <div class="product-item product-item-box">
                                <div class="product-image"
                                    style="height: 220px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                                    @if($product && $product->image_url)
                                        <img src="{{ asset('storage/' . $product->image_url) }}" alt="{{ $product->name }}"
                                            style="height: 100%; width: auto; object-fit: contain;" />
                                    @else
                                        <img src="{{ asset('client/assets/images/portfolio/grid-portfolio1.jpg') }}"
                                            alt="Default Product Image" style="height: 100%; width: auto; object-fit: contain;" />
                                    @endif
                                    ...
                                    <div class="product-price font-alt">
                                        ...
                                        @elseif($product->price > 0)
                                            ...
                                            @if($product->compare_price && $product->compare_price > $product->price)
                                                <span
                                                    class="price-old">{{ number_format($product->compare_price, 0, '.', '.') }}₫</span>
                                            @endif
                                        @else
                        ...
                        @foreach ($productsFavorite as $product)
                            @if ($product)
                                <div class="flex-shrink-0"
                                    style="scroll-snap-align: start; width: 33.3333%; min-width: 300px; max-width: 33.3333%;">
                                    <div class="product-item"
                                        style="box-shadow: 0 2px 6px rgba(0,0,0,0.1); border-radius: 8px; background: #fff; overflow: hidden;">
                                        <div class="product-image"
                                            style="height: 220px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
                                        ...
                                        <div class="product-info text-center mt-20 p-3">
                                            ...
                                            <small class="text-muted">Yêu thích: {{ $product->favorites_count }} | Lượt xem:
                                                {{ $product->view }}</small>
                                        </div>
                                    </div>
                                </div>
