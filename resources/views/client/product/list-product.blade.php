    ...
    <div class="products-container">
      <div class="row multi-columns-row">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
          <div class="shop-item">
            <div class="shop-item-image" style="height: 220px; overflow: hidden; display: flex; align-items: center; justify-content: center; position: relative; border-radius: 8px;">
              <a href="{{ route('client.single-product', $product->id) }}" style="display: block; width: 100%; height: 100%; position: relative;">
                @if($product->variants->count() > 1)
                <div class="product-badge" style="position: absolute; top: 10px; right: 10px; z-index: 3;">
                ...
                <img src="{{ asset('storage/' . $product->image) }}"
                  ...
                  style="max-height: 100%; max-width: 100%; object-fit: contain; border-radius: 4px; display: block; margin: 0 auto;" />
...
<script>
  ...
  function testPriceFilter(min = {
    {
      round($minPrice + ($maxPrice - $minPrice) * 0.3)
    }
  }, max = {
    {
      round($minPrice + ($maxPrice - $minPrice) * 0.7)
    }
  }) {
    console.log('Testing price filter with:', {
      min,
      max
    });
