...
@section('content')
    ...
    <div class="row">
      ...
      @endif
        ...
        <div class="row mb-20">
          ...
          <select class="form-control input-lg" name="variant_id" required onchange="updatePriceAndStock(this)"
            id="variant-select">
        ...
        @endforeach
          ...
          <input class="form-control input-lg" type="number" name="quantity" value="1" max="100" min="1"
            required="required" id="quantity-input" />
  ...
  <section class="module-small">
    ...
    <div class="row multi-columns-row">
      ...
      <a href="{{ route('client.single-product', $relatedProduct->id) }}" class="btn btn-outline">
