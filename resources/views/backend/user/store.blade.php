                        ...
                        <div class="row mb10">
                                ...
                                <div class="form-row">
                                    ...
                                    <select name="province_id" class="form-control setupSelect2 province location" data-target="districts" id="">
                                        ...
                                        $foreach($provinces as $province)
                                            <option 
                                                @if 
                                                    (old('province_id') == $provinces -> code) selected 
                                                @endif 
                                            value="{{ $provinces -> code}}">{{ $province -> name}}</option>
                                        @endforeach
                                        @endif
                                    </select>
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <select name="district_id" class="form-control districts setupSelect2 location" data-target="ward" id="">
