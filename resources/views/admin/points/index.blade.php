                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="ibox">
                                <div class="ibox-title">
                                    <h5><i class="fa fa-gift text-danger"></i> Voucher Được Sử Dụng Nhiều</h5>
                                </div>
                                <div class="ibox-content">
                                            ...
                                            @foreach($topVouchers as $voucher)
                                                <div class="list-group-item">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <span class="badge badge-primary">{{ $voucher->user_vouchers_count }}</span>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                        <div class="text-center mt-3">
                                            <a href="{{ route('admin.points.vouchers') }}" class="btn btn-outline-primary">
                                                Quản lý voucher
                                            </a>
                                        </div>
                                    @else
                            ...
                            <div class="ibox">
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <a href="{{ route('admin.points.vouchers') }}" class="btn btn-success btn-block">
                                                <i class="fa fa-gift"></i> Quản lý Voucher
                                            </a>
                                        </div>
                                        <div class="col-md-3">
