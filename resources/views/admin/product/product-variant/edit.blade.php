                        ...
                        <form method="POST" action="{{ route('admin.product.product-variant.update', $variant->id) }}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="variant_name"
                                        ...
                                        required placeholder="Enter variant name">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class="help-block m-b-none">Set the promotion price for this variant (optional)</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="stock_quantity"
                                        value="{{ old('stock_quantity', $variant->stock_quantity) }}" class="form-control"
                                        required placeholder="Enter stock quantity" min="0">
                                                ...
                                                @foreach($images as $image)
                                                    <div class="col-md-3 mb-2">
                                                        <div class="image-container" style="position: relative; margin-bottom: 10px;">
                                                            <img src="{{ asset('storage/' . $image) }}" alt="Product variant image"
                                                                class="img-responsive"
                                                                style="max-height: 120px; width: 100%; object-fit: cover; border-radius: 4px; border: 1px solid #ddd;">
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="file" name="image_variant[]" class="form-control" accept="image/*"
                                        multiple>
                                    <span class="help-block m-b-none">Upload new variant images (JPG, PNG, WebP - Max: 2MB
                                        each). This will replace existing images.</span>
                                </div>
                            </div>
