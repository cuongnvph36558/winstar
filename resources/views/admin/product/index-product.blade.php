                                ...
                                <tbody>
                                    @forelse ($products as $product)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if($product->image)
                                                    <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}"
                                                        width="60" height="60" class="img-rounded" style="object-fit: cover;">
                                                @else
                                            ...
                                            <td>
                                                <span
                                                    class="label label-primary">{{ $product->category->name ?? 'Không có danh mục' }}</span>
                                            </td>
                                            <td class="text-right">
                                                @if($variant)
                                                    <strong class="text-success">{{ number_format($variant->price, 0, ',', '.') }}
                                                        VND</strong>
                                                    @if($product->variants->count() > 1)
                                                        <br><small class="text-muted">Từ
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    ...
                                                    <form action="{{ route('admin.product.delete', $product->id) }}"
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="btn btn-danger btn-xs" title="Xóa sản phẩm"
                                        ...
                                        <tr>
                                            <td colspan="7" class="text-center text-muted">
                                                <div style="padding: 40px;">
                                                    ...
                                                    <p>Thêm sản phẩm đầu tiên của bạn</p>
                                                    <a href="{{ route('admin.product.create-product') }}"
