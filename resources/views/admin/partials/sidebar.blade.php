    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
                    ...
                    <ul class="dropdown-menu animated fadeInRight m-t-xs">
                        ...
                        <li>
                            <form method="POST" action="{{ route('logout') }}" style="display: inline;">
                                @csrf
                                <button type="submit" style="background: none; border: none; color: inherit; cursor: pointer; width: 100%; text-align: left; padding: 3px 20px;">
                                    Đăng xuất
                                </button>
                            </form>
                        </li>
            ...
            <li class="{{ request()->is('admin/roles*') || request()->is('admin/permissions*') ? 'active' : '' }}">
                <a href="#"><i class="fa fa-shield"></i> <span class="nav-label">Phân Quyền</span><span class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse {{ request()->is('admin/roles*') || request()->is('admin/permissions*') ? 'in' : '' }}">
                    @can('role.view')
            ...
            <li class="{{ request()->is('admin/reports*') ? 'active' : '' }}">
                <a href="#"><i class="fa fa-bar-chart-o"></i> <span class="nav-label">Báo cáo</span><span class="fa arrow"></span></a>
