                    ...
                    <li>
                        <div class="dropdown-messages-box">
                            ...
                            <div class="media-body">
                                ...
                                <strong>Mike Loreipsum</strong> đã bắt đầu theo dõi <strong>Monica
                                    Smith</strong>. <br>
                                <small class="text-muted">3 ngày trước lúc 7:58 tối - 10.06.2014</small>
                            </div>
                        </div>
                    </li>
                    <li class="divider"></li>
                    <li>
                        <div class="dropdown-messages-box">
                            ...
                            <div class="media-body ">
                                ...
                                <strong>Chris Johnatan Overtunk</strong> đã bắt đầu theo dõi <strong>Monica
                                    Smith</strong>. <br>
                                <small class="text-muted">Hôm qua 1:21 chiều - 11.06.2014</small>
                            </div>
                        </div>
                    </li>
                    <li class="divider"></li>
                    <li>
                        <div class="dropdown-messages-box">
                            ...
                            <div class="media-body ">
                                ...
                                <strong>Monica Smith</strong> thích <strong>Kim Smith</strong>. <br>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-alerts">
                    <li>
                        <a href="mailbox.html">
                            <div>
                                <i class="fa fa-envelope fa-fw"></i> Bạn có 16 tin nhắn mới
                    ...
                    <li>
                        <a href="grid_options.html">
                            <div>
                                <i class="fa fa-upload fa-fw"></i> Máy chủ đã khởi động lại
                                <span class="pull-right text-muted small">4 phút trước</span>
                            </div>
                        </a>
                    </li>
